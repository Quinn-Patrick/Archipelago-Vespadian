...
def create_regions(multiworld: MultiWorld, player: int, options):
    ...
    regions["Menendel Underground"].locations.append("Menendel Underground Corridors Chest 5")
    ...
    regions["Mole Hole"].locations.append("Mole Hole Depths Key Chest")
    regions["Mole Hole"].locations.append("Mole Hole Depths Chest 1")
